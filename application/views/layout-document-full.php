...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo base_url('assets/css/icon.css');?>" media="screen,projection"/>
    <!-- Custom CSS -->
  ...
  <body>
    ...
    <header>
      ...
      <ul id="nav-mobile" class="side-nav fixed">
        <center>
          <img class="circle responsive-img z-depth-3" src="<?php echo base_url('assets/img/myAvatar.png');?>" style="width: 70%; margin-top: 5%; margin-bottom: 5%;">
          <h5>Hi, Admin</h5>
        </center><br>
        ...
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            <li class="bold"><a class="collapsible-header waves-effect"><i class="material-icons">file_download</i>Cetak Laporan</a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="export_excel.php">Cetak ke Excel</a></li>
